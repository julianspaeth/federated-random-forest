...
from survival.splitting import _find_split
import numpy as np
import pandas as pd
...
class RandomForest:
    ...
    def _create_tree(self, x, y, i: int):
        """
        ...
        tree = DecisionTree(x=x.iloc[self.bootstrap_idxs[i], :], y=y.iloc[self.bootstrap_idxs[i], :],
...
class Node:
    ...
    def __init__(self, x, y, tree: DecisionTree, f_idxs: list, n_features: int, timeline, random_instance,
